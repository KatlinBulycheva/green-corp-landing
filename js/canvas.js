...
class CanvasBackground {
    ...
    animate() {
        ...
        this.bubblesList.forEach((bubble) => {
            ...
            this.ctx.beginPath();
            this.ctx.arc(bubble.translateX, bubble.translateY, bubble.size, 0, 2 * Math.PI); // вместо 0,0 используется bubble.translateX,bubble.translateY
...
let result = new CanvasBackground("orb-canvas");
result.start();